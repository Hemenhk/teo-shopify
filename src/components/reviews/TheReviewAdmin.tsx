...
import { useAllReviewsQuery } from "@/hooks/useQueryHooks";
import { ReviewProps } from "@/axios/review-req";
import TheFilteredReviews from "./TheFilteredReviews";
import TheEditReview from "./edit-reviews/TheEditReview";

export default function TheReviewAdmin() {
  const { data: reviews, isError, isLoading } = useAllReviewsQuery();
